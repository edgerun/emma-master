package io.edgerun.emma.controller.service.sub;
...
public class SubscriptionTableTest {
    ...
    public void remove_withBroker_removesAndReturnsCorrectEntries() throws Exception {
        ...
        assertThat(removed, CoreMatchers.hasItems(sub11, sub12));

        assertThat(table.getSubscriptions().size(), is(1));
        assertThat(table.getSubscriptions(), CoreMatchers.hasItem(sub21));
    }
